...
function header() {
  ...
  <div class="bg-[#d3441ecc] hidden md:block">
    <div class="flex md:justify-end justify-between items-center p-4 md:px-12 max-w-screen-2xl mx-auto text-white">
  ...
  <nav class="relative 2xl:px-12 px-4 py-4 flex justify-between items-center bg-white">
    <a
        ...
        <li>
          ...
          <div id="dropdownNavbar"
            ...
            <ul class="p-2 text-sm font-medium space-y-3" aria-labelledby="dropdownLargeButton">
              <li><a href="../../products/pos.html" class="flex items-center px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3">
                  <div><img src="/assets/images/products/point-of-sale.png" alt="" /></div>Point of sale
                </a></li>
              <li><a href="../../products/kiosk.html" class="flex items-center px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3">
                  <div><img src="/assets/images/products/kiosk.png" alt="" /></div>Kiosk Self Service
                </a></li>
              <li><a href="../../products/kds.html" class="flex items-center px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3">
              ...
              <li><a href="../../products/loyalty.html" class="flex items-center px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3">
                  <div><img src="/assets/images/products/loyalty-pro.png" alt="" /></div>Loyalty Program
                </a></li>
                <li><a href="../../products/payments.html" class="flex items-center px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3">
              ...
              <li><a href="../../products/coupons.html" class="flex items-center px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3">
          ...
          <ul class="divide-y divide-[#d3441ecc]">
            <li>
              ...
              <div id="dropdownMobileNavbar"
                ...
                <ul class="p-2 text-sm font-medium space-y-3" aria-labelledby="dropdownLargeButton">
                  <li><a href="../../products/pos.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/point-of-sale.png" alt="" />Point of sale</a></li>
                  <li><a href="../../products/kiosk.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/kiosk.png" alt="" />Kiosk Self Service</a></li>
                  <li><a href="../../products/kds.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                  ...
                  <li><a href="../../products/ecommerce.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                  ...
                  <li><a href="../../products/loyalty.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/loyalty-pro.png" alt="" />Loyalty Program</a></li>
                  <li><a href="../../products/payments.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                          src="/assets/images/products/payments.png" alt="" />Payments </a></li>
                  <li><a href="../../products/inventory.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/inventory-management.png" alt="" />Inventory Management</a></li>
                  <li><a href="../../products/ai-product.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/product-recommendations.png" alt="" />Product Recommendations
                      <br />using AI</a></li>
                  <li><a href="../../products/tableside.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/tableside-ordering.png" alt="" />Tableside Ordering / BYOD</a>
                  </li>
                  <li><a href="../../products/advanced-analytics.html"
                      class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/advanced-reports.png" alt="" />Advanced Reports</a></li>
                  <li><a href="../../products/aggregator.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/aggregator.png" alt="" />Aggregator Integration</a></li>
                  <li><a href="../../products/coupons.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
                        src="/assets/images/products/coupons-discounts.png" alt="" />Coupons & Discounts</a></li>
                  <li><a href="../../products/email-sms.html" class="block px-4 py-3 hover:bg-[#D243211A] rounded-lg flex gap-3"><img
  ...
  <div class="bg-[#DC694B] py-4 flex 2xl:justify-center items-center space-x-6 products-nav overflow-auto px-4 hidden"
    id="productsNav"><a href="../../products/pos.html">
